...
/*   Updated: 2023/12/10 16:17:51 by ncasteln         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_tmp_name(t_redir_data *redir_cont, int fd_tmp, int n) // new version
{
	char	*tmp_name;
...
*/
int	get_fd_tmp(t_redir_data *redir_cont, int fd_tmp, int n) // old version
{
	char	*tmp_name;
