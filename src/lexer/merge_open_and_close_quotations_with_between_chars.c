...
/*   Updated: 2023/10/29 17:28:27 by fahmadia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

bool	is_closing_quote_pair(t_token_data *cur_tkn_data, t_list *cur_quoted_node, char tkn_type)
{
...
bool	merge_two_str_node(t_list *tkns_head, t_list *cur_node, t_list *cur_quoted_node, char tkn_type)
{
...
bool	loop_over_quoted_tokens(t_list *tkns_head, t_list *cur_node, t_list **cur_quoted_node, char tkn_type)
{
	...
	// {
		if (merge_two_str_node(tkns_head, cur_node, *cur_quoted_node, tkn_type))
		{
