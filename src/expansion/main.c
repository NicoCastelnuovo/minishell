...
/*   Updated: 2023/11/08 16:22:39 by ncasteln         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	Compiling Command
	cc ./src/env_dlst/env_dlst_append.c ./src/env_dlst/env_dlst_clear.c ./src/env_dlst/env_dlst_delnode.c  ./src/env_dlst/env_dlst_new.c ./src/env_dlst/env_dlst_update.c ./src/builtins/export.c ./src/builtins/env.c ./src/expansion/main.c ./src/expansion/utils.c ./src/expansion/expansion.c ./src/expansion/build_str.c -I./include/ -I./mylib/libft/ -I./mylib/ft_printf/ -I./mylib/get_next_line/ -L./mylib/ -lmylib
*/
...
// 	char *new_string = expansion("$TERM>>", 99, env);
// 	free(new_string);
